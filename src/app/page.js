...
//   // Slider Images
//   const slides = [
//     "https://ik.imagekit.io/warriordc/Rajasthan-meat-shop/store-front.jpg?updatedAt=1756806992496",
...
//         <button
//           onClick={prevSlide}
//           className="absolute left-4 bg-white/60 p-2 rounded-full hover:bg-white"
//         >
//           <ChevronLeft className="text-gray-800" size={28} />
//         </button>
//         <button
//           onClick={nextSlide}
//           className="absolute right-4 bg-white/60 p-2 rounded-full hover:bg-white"
//         >
...
//       {/* Extra Section for Length & Creativity */}
...
//           transition={{ delay: 0.2, duration: 0.8 }}
//         >
//           We bring you **farm-fresh meat daily** with top-notch hygiene, fast
//           delivery, and halal certification. Trusted by thousands of families
